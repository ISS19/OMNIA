...
<body>
        <header id="header">
            ...
            <ul class="menu" data-aos="fade-left" data-aos-delay="80" data-aos-duration="1500">
                <li class="azerty"><a href="apropos.php">A propos</a></li>
...
<form id="auth" method="post">
        ...
        <div class="header"><input type="submit" name="conn" value="Connection" class="envoi" style="margin-top: 25px;"></div>
    <a href="auth.php" style="margin-top: 15px;" class="aza">Vous n'avez pas encore de compte?</a>
    </form>
</body>
</html>